// mapping/constants.js
// -----------------------------------------------------------------------------
// Core constants and lookup tables for the Cross‑Stitch Editor (frontend‑only).
// This file contains:
// - DMC thread list (code, name, RGB)
// - Dithering matrices & kernels
// - Symbol sets & families
...
// DMC THREAD PALETTE
// -----------------------------------------------------------------------------
// Each entry: [code, name, "#RRGGBB"]
// Converted directly from Python. No backend dependencies.
...
export const DMC = [
    ...
    ["16", "Chartreuse Light", "#C9C258"],
    ["17", "Yellow Plum Light", "#E5E272"],
    ["18", "Yellow Plum", "#D9D56D"],
    ["19", "Autumn Gold medium Light", "#F7C95F"],
    ["20", "Shrimp", "#F7AF93"],
    ["21", "Alizarin Light", "#D79982"],
    ["22", "Alizarin", "#BC604E"],
    ["23", "Apple Blossom", "#EDE2ED"],
    ["24", "White Lavender", "#E0D7EE"],
    ["25", "Lavender Ultra Light", "#DAD2E9"],
    ["26", "Lavender Pale", "#D7CAE6"],
    ["27", "White Violet", "#F0EEF9"],
    ["28", "Eggplant Medium Light", "#9086A9"],
    ["29", "Eggplant", "#674076"],
    ["30", "Blueberry Medium Light", "#7D77A5"],
    ["31", "Blueberry", "#50518D"],
    ["32", "Blueberry Dark", "#4D2E8A"],
    ["33", "Fuschia", "#9C599C"],
    ["34", "Fuschia Dark", "#7D3064"],
    ["35", "Fuschia Very Dark", "#46052D"],
    ...
    ["158", "Cornflower Blue Very Dark", "#4C526E"],
    ...
    ["310", "Black", "#000000"],
    ["311", "Wedgewood Ultra Very Dark", "#1C5066"],
    ...
    ["319", "Pistachio Grn Very Dark", "#205F2E"],
    ...
    ["470", "Avocado Grn Light", "#94AB4F"],
    ["471", "Avocado Grn Very Light", "#AEBF79"],
    ...
    ["705", "Green Bright", "#00A86B"],
    ["706", "Green Light Bright", "#00C17A"],
    ["707", "Green Very Light Bright", "#00D68F"],
    ["712", "Cream", "#FFFBEF"],
    ["718", "Plum", "#9C2462"],
    ...
    ["868", "Medium Very Dark Shell Pink", "#B08968"],
    ["869", "Hazelnut Brown Very Dark", "#835E39"],
    ["890", "Pistachio Grn Ultra Very Dark", "#184923"],
    ...
    ["943", "Green Bright Medium", "#3D9384"],
    ["945", "Tawny", "#FBD5BB"],
    ...
    ["3802", "Antique Mauve Very Darkv", "#714149"],
    ...
    ["3812", "Sea Green Very Dark", "#2F8C84"],
    ...
    ["3845", "Turquoise Bright Medium", "#04C4CA"],
...
// Precomputed: [code, name, [r,g,b]]
export const DMC_RGB = DMC.map(([code, name, hex]) => {
    return [code, name, hexToRgb(hex)];
});
...
// Symbol families (used to avoid visually similar symbols on similar colours)
export const SYMBOL_FAMILIES = {
    ...
    symbols: new Set(["☯", "☘", "☻", "☗"]),
    math: new Set(["⋂", "⋃", "╦", "╬"]),
    letters: new Set(["A","B","D","E","F","H","K","M","N","R","T","U","V","W","X"]),
    numbers: new Set(["2","4","5","7","8"]),
};

// Reverse lookup: symbol → family
export const symbolToFamily = {};
for (const [family, set] of Object.entries(SYMBOL_FAMILIES)) {
    for (const sym of set) {
        symbolToFamily[sym] = family;
    }
}
...
export function colourDistance(c1, c2) {
    const dr = c1[0] - c2[0];
    const dg = c1[1] - c2[1];
    const db = c1[2] - c2[2];
...
// True if two symbols belong to the same visual family
export function symbolsTooSimilar(sym1, sym2) {
    return symbolToFamily[sym1] === symbolToFamily[sym2];
}

// Threshold for symbol safety
export const SIMILAR_COLOUR_THRESHOLD = 40;
