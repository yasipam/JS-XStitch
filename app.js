...
let pendingSaveSlotId = null;
let pendingDeleteSlotId = null;
let fileDropdownOpen = false;

async function setupFileDropdown() {
    ...
    // Close save slots submenu when clicking outside
    document.addEventListener('click', (e) => {
    ...
    // Import OXS button - close dropdown first, then delegate to existing handler
    ...
    // New Canvas button - close dropdown first
...
async function refreshSaveSlotsList() {
...
async function loadProjectFromSlot(slotId) {
    try {
